...
app.add_url_rule('/cafe', 'cafe', clientviews.all_, methods=['POST', 'GET'])
app.add_url_rule('/food', 'food', clientviews.all_, methods=['POST', 'GET'])
app.add_url_rule('/breakfast', 'breakfast', clientviews.all_, methods=['POST', 'GET'])
